...
Ground::Ground(glm::vec3 cubeMin, glm::vec3 cubeMax)
{
    // Model matrix.
    model = glm::mat4(1.0f);
    
    // The color of the Ground. Try setting it to something else!
...
void Ground::update()
{
    // Spin the Ground by 1 degree.
//    spin(0.1f);
}

////////////////////////////////////////////////////////////////////////////////

void Ground::spin(float deg)
{
